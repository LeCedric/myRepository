...
/**
 * This is the item provider adapter for a {@link com.tad.school.MSchool} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchoolItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_School_teachers_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_School_teachers_feature", "_UI_School_type"),
				 MSchoolPackage.Literals.SCHOOL__TEACHERS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addStudentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_School_students_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_School_students_feature", "_UI_School_type"),
				 MSchoolPackage.Literals.SCHOOL__STUDENTS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MSchoolPackage.Literals.SCHOOL__NAME,
				 true,
				 false,
				 false,
	...
	protected void addRankPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_School_rank_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_School_rank_feature", "_UI_School_type"),
				 MSchoolPackage.Literals.SCHOOL__RANK,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MSchoolPackage.Literals.SCHOOL__ROOMS);
		}
	...
	public String getText(Object object) {
		String label = ((MSchool)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MSchool.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MSchoolPackage.Literals.SCHOOL__ROOMS,
				 MSchoolFactory.eINSTANCE.createClassRoom()));
	}
