...
/**
 * This is the item provider adapter for a {@link com.tad.school.MStudent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StudentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MSchoolPackage.Literals.STUDENT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MSchoolPackage.Literals.STUDENT__AGE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MSchoolPackage.Literals.STUDENT__AGE);
			childrenFeatures.add(MSchoolPackage.Literals.STUDENT__NOTATIONS);
		}
	...
	public String getText(Object object) {
		String label = ((MStudent)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MStudent.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MSchoolPackage.Literals.STUDENT__NOTATIONS,
				 MSchoolFactory.eINSTANCE.createNotation()));
	}
